...
std::string FontEngine::stringOfAlignment(int align)
{
    char buffer[32];
    ...
    switch (align & (AlignTop|AlignBottom)) {
    case AlignTop: vertical = "top"; break;
    case AlignBottom: vertical = "bottom"; break;
    case 0: default: break;
    }

    switch (align & (AlignLeft|AlignRight)) {
    case AlignLeft: horizontal = "left"; break;
    case AlignRight: horizontal = "right"; break;
    case 0: default: break;
    }

    if (vertical && horizontal)
        sprintf(buffer, "%s-%s", vertical, horizontal);
    else if (vertical)
    ...
    if (align & AlignInside)
        strcat(buffer, " inside");
